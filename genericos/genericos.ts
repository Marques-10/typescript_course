...
console.log(new SomaBinaria(30, 480).executar())
...
class DiferencaEntreDatas extends OperacaoBinaria<Data, string>{
    ...
    executar(): string {
        ...
        return `A diferença é de: ${Math.ceil(diferenca / dia)} dias.`
    
    }
}

const d1 = new Data(1, 2, 2020)
const d2 = new Data(5, 2, 2024)
...
const fila = new Fila<string>('Ana', 'Lúcia', 'Maria')
fila.imprimir()
fila.entrar('Rafael')
fila.imprimir()
